...
echo -e "==================================================================="
echo -e "     Set Your YPanel Database Info | AUTOSCRIPT BY JOHNFORDTV       "
echo -e "==================================================================="
read -p "Database Host: " -e -i DBHost DatabaseHost
read -p "Database Password: " -e -i DBPass DatabasePass
read -p "Database User: " -e -i DBUser DatabaseUser
