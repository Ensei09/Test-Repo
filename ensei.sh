...
MyScriptName='Eldanjohn Villanueva'
...
do
    case $opt in
		...
		display_menu
		ports
		echo -e "\033[1;32m		Premium Category Installation Done!\033[0m"
		break;;
		...
		display_menu
		ports
		echo -e "\033[1;32m		VIP Category Installation Done!\033[0m"
		break;;
        ...
        systemctl enable openvpn
        systemctl restart openvpn
        echo -e "\n  \033[1;32mAdding Private Category...\033[0m"
        privatecategory			
		sleep 3
		clear
		display_menu
		ports
		echo -e "\033[1;32m		Private CategoryInstallation Done!\033[0m"
		break;;
