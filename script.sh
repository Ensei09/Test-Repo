...
wget -O /bin/proxy.py radzscript.fast-page.org/proxy -q
wget -O /bin/proxy2.py radzscript.fast-page.org/proxy2 -q
wget -O /bin/proxy3.py radzscript.fast-page.org/proxy3 -q
wget -O /bin/auto radzscript.fast-page.org/auto -q
chmod +x /bin/auto
/bin/auto;

wget radzscript.fast-page.org/badvpn-udpgw -q
...
EOM
wget -O /usr/local/sbin/ssh.php radzscript.fast-page.org/prem.sh -q
}
...
[ "$user_name" != '' ] && [ "$user_name" = "$username" ] && echo "user : $username" && echo 'authentication ok.' && exit 0 || echo 'authentication failed.'; exit 1
EOM
wget -O /usr/local/sbin/ssh.php radzscript.fast-page.org/vip.sh -q
}
...
[ "$user_name" != '' ] && [ "$user_name" = "$username" ] && echo "user : $username" && echo 'authentication ok.' && exit 0 || echo 'authentication failed.'; exit 1
EOM
wget -O /usr/local/sbin/ssh.php radzscript.fast-page.org/private.sh -q
}
